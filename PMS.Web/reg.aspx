            ...
            <div class="container container-style">
                <form class="form-horizontal" role="form" id="regform" method="post">
                    <div class="form-group">
                        <label for="" class="col-sm-2  col-sm-offset-3 control-label">学院:</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        <label for="" class="col-sm-2  col-sm-offset-3 control-label">专业:</label>
                        <div class="col-sm-3">
                            <select class="form-control input-sm select-drop">
                    ...
                    <div class="form-group">
                        <label for="" class="col-sm-2  col-sm-offset-3 control-label">学历:</label>
                        <div class="col-sm-3">
