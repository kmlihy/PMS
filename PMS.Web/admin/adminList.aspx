                ...
                <table class="table table-bordered table-hover">
                    ...
                    {%>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-default btn-sm btn-warning" id="btnEdit" data-toggle="modal" data-target="#editModal">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="delModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <%for (int i = 0; i < dsColl.Tables[0].Rows.Count; i++)
                                            {
                                                if (dsColl.Tables[0].Rows[i]["collegeName"].ToString() == "会计学院")
                                                {%>
                                                    <option value="" selected="selected"><%=dsColl.Tables[0].Rows[i]["collegeName"].ToString() %></option>
                                              <%}
                                                      else
                                                      {%>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
                            <button type="button" class="btn btn-primary" id="btnEdit">提交更改</button>
                        </div>
                    </div>
                </div>
            </div>
