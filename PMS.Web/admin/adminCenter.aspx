<%@ Page Language="C#" AutoEventWireup="true" Debug="true" CodeBehind="adminCenter.aspx.cs" Inherits="PMS.Web.admin.adminCenter" %>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="centerLable">
                                    ...
                                    <button type="submit" class="btn btn-info" id="okMessage" onclick="ok('admin')">确定</button>
                                </td>
                                <td></td>
                                <td id="">
