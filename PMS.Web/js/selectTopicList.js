...
$(document).ready(function () {
    ...
    function jump(cur) {
        ...
        window.location.href = "selectTopicList.aspx?currentPage=" + cur + "&dropstrWhere=" + sessionStorage.getItem("dropstrWhere") + "&batchWhere=" + sessionStorage.getItem("batchWhere");
    }
};
//查看详情弹窗数据填充
