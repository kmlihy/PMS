...
function jump(cur) {
    ...
    if (type == "up" || type == "plandropUp" || type == "prodropUp" || type == "alldropUp") {
        if (strWhere != null) {
            window.location.href = "adminViewScore.aspx?currentPage=" + cur + "&search=" + strWhere + "&type=" + type + "&order=up" + "&op=" + sessionStorage.getItem("op");
        }
        else if (planId != null && proId == null) {
            window.location.href = "adminViewScore.aspx?currentPage=" + cur + "&dropstrWhereplan=" + planId + "&type=" + type + "&order=up" + "&op=" + sessionStorage.getItem("op");
        }
        else if (proId != null && planId == null) {
            window.location.href = "adminViewScore.aspx?currentPage=" + cur + "&dropstrWherepro=" + proId + "&type=" + type + "&order=up" + "&op=" + sessionStorage.getItem("op");
        }
        else if (proId != null && planId != null) {
            window.location.href = "adminViewScore.aspx?currentPage=" + cur + "&dropstrWherepro=" + proId + "&dropstrWhereplan=" + planId + "&type=" + type + "&order=up" + "&op=" + sessionStorage.getItem("op");
        } else {
            window.location.href = "adminViewScore.aspx?currentPage=" + cur + "&order=up" + "&op=" + sessionStorage.getItem("op");
        }
    }
    else {
        if (strWhere != null) {
            window.location.href = "adminViewScore.aspx?currentPage=" + cur + "&search=" + strWhere + "&type=" + type + "&order=down" + "&op=" + sessionStorage.getItem("op");
        }
        else if (planId != null && proId == null) {
            window.location.href = "adminViewScore.aspx?currentPage=" + cur + "&dropstrWhereplan=" + planId + "&type=" + type + "&order=down" + "&op=" + sessionStorage.getItem("op");
        }
        else if (proId != null && planId == null) {
            window.location.href = "adminViewScore.aspx?currentPage=" + cur + "&dropstrWherepro=" + proId + "&type=" + type + "&order=down" + "&op=" + sessionStorage.getItem("op");
        }
        else if (proId != null && planId != null) {
            window.location.href = "adminViewScore.aspx?currentPage=" + cur + "&dropstrWherepro=" + proId + "&dropstrWhereplan=" + planId + "&type=" + type + "&order=down" + "&op=" + sessionStorage.getItem("op");
        } else {
            window.location.href = "adminViewScore.aspx?currentPage=" + cur + "&order=down" + "&op=" + sessionStorage.getItem("op");
        }
    }
};
//翻页事件
