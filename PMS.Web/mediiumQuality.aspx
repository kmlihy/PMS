        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <table class="table" id="mediumQuality_table">
                    ...
                    <tr class="table_head">
                        <td class="col-sm-1">毕业设计（论文）题目</td>
                        <td class="col-md-1" colspan="8"><%=title %></td>
                    </tr>
                    <tr class="table_head">
                    ...
                    <tr>
                        ...
                        <td colspan="4" style="padding: 0 0;">
                            ...
                            <%}
                                ...
                                { %>
                            <textarea rows="5" class="textArea text-primary" id="groupShow" readonly="readonly">提交后请等待毕业设计（论文）指导小组回复</textarea>
                            <%} %>
                            <div class="text-right" style="width: 100%">
                                <span>指导小组签字：</span>
                                <span contenteditable="true" class="label_Time">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
